                ...
                <div class="row">
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            ...
                            <div>
                                <a href="{{ url('admin/add-news-and-update') }}"><button type="button" class="btn btn-primary">Create News & Events</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                @if (!empty($allNewsUpdates))
                                                    @foreach ($allNewsUpdates as $news_update)
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ $news_update->image_url }}" alt=""
                                                            ...
                                                            @endif
                                                                <td>
                                                            @if ($news_update->publication_status == '1')
                                                                <a href="inactive-news-update/{{ $news_update->id }}"
                                                                        class="btn btn-danger">InActive</a>
                                                            @else
                                                                <a href="active-news-update/{{ $news_update->id }}"
                                                                        class="btn btn-success">Active</a>
                                                            @endif
                                                            <a href="edit-news-update/{{ $news_update->id }}"
                                                                class="btn btn-info">Edit</a>
                                                                <a href="delete-news-update/{{ $news_update->id }}"
