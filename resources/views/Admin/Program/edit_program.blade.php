                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form action="{{ url('admin/update-program') }}/{{ $editProgram->id }}" method="post"  enctype="multipart/form-data">
                                            <input type="hidden" name="id" {{ $editProgram->id }}>
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $editProgram->program_name }}" name="program_name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $editProgram->duration }}" name="duration">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 ml-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" value="{{ $editProgram->image_url }}" name="image_url" id="thumbnail-value" placeholder="Please Select Thumbnail From Media" readonly style="width=200px !important;">
                                                            </div>
