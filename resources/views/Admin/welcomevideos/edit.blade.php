            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <h4>Update New Video</h4>
                            <div class="card">

                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form action="{{ url('admin/update-video') }}/{{ $editVideo->id }}" method="post"  enctype="multipart/form-data">
                                            <input type="hidden" name="id" id="" value="{{ $editVideo->id }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Title</label>
                                                        <input type="text" class="form-control" name="title" value="{{ $editVideo->title }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="short_intro" value="{{ $editVideo->short_introduction }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="video_url" value="{{ $editVideo->video_url }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 ml-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" value="{{ $editVideo->image_url }}" name="image_url" id="thumbnail-value" placeholder="Please Select Thumbnail From Media" readonly style="width=200px !important;">
                                                            </div>
