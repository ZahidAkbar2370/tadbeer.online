                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 ml-1">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="password" id="thumbnail-value" placeholder="Please Select Thumbnail From Media" readonly style="width=200px !important;">
                                                            </div>
