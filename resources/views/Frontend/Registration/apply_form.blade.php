            ...
            <form action="{{ url('apply') }}" method="post">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12 col-md-12 padding-70px-right lg-padding-40px-right md-padding-15px-right">
                        <span
                            class="alt-font text-large text-extra-dark-gray margin-40px-bottom d-inline-block font-weight-500">Personal
                            Information</span>

                        <div class="row">
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Email<span class="text-radical-red"> *</span></label>
                                <input class="small-input" type="email" name="email" placeholder="Your Email Address"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Your Name <span class="text-radical-red"> *</span></label>
                                <input class="small-input" type="text" name="student_name" placeholder="Enter Your Name"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Father Name <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="text" name="father_name" placeholder="Enter Father Name"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Date of Birth <span class="text-radical-red">
                                        *</span></label>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Parmanent Address<span class="text-radical-red">
                                        *</span></label>
                                <textarea class="medium-input" rows="2" cols="5" name="address" required
                                    placeholder="Your Address as Per CNIC"></textarea>
                            </div>
                    ...
                    <div class="col-12 col-lg-12 col-md-12 padding-70px-right lg-padding-40px-right md-padding-15px-right">
                        <span
                            class="alt-font text-large text-extra-dark-gray margin-40px-bottom d-inline-block font-weight-500">Madrassah
                            Education</span>
                        <div class="row">
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Aalmiyyah (Total No) <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="number" name="total_marks" placeholder="Your Answer"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Obtained Marks <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="number" name="obtained_marks" placeholder="Your Answer"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Percentage <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="text" name="percentage" placeholder="Percentage 100%"
                                    required>
                            </div>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom" for="contry">Board <span
                    ...
                    <div class="col-12 col-lg-12 col-md-12 padding-70px-right lg-padding-40px-right md-padding-15px-right">
                        <span
                            class="alt-font text-large text-extra-dark-gray margin-40px-bottom d-inline-block font-weight-500">Contemporary
                            Education</span>
                        <div class="row">
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Bachelors (BA/BS) Obtained Marks <span
                                        class="text-radical-red"> *</span></label> <span class="text-radical-red">
                                    *</span></label>
                                <input class="small-input" type="number" name="backelors_obtained_marks"
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Percentage <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="text" name="bachelors_percentage"
                                    placeholder="Percentage 100%" required>
                            </div>

                            <div class="col-md-12 margin-10px-bottom">
                                <label class="margin-15px-bottom">University/Board <span class="text-radical-red">
                                        *</span></label>
                                <input class="small-input" type="text" name="board_university_name" required
                                    placeholder="University/Board Name">
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Master (MA) Obtained Marks</label> <span
                                    class="text-radical-red"> *</span></label>
                                <input class="small-input" type="number" name="master_obtained_marks"
                                    placeholder="Your Answer" required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Percentage</label>
                                <input class="small-input" type="text" name="master_percentage"
                                    placeholder="Percentage 100%" required>
                            </div>

                            <div class="col-md-12 margin-10px-bottom">
                                <label class="margin-15px-bottom">University </label>
                                <input class="small-input" type="text" name="university_name"
                                    placeholder="University Name">
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Optional</label>
                                <input class="small-input" type="text" name="optional"
                                    placeholder="Your Skills or any other degree">
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom" for="contry">Board <span
                                        class="text-radical-red">*</span></label>
                                <select name="optional_expert" id="board" class="small-input" required>
                    ...
                    <div class="col-12 col-lg-12 col-md-12 padding-70px-right lg-padding-40px-right md-padding-15px-right">
                        <span
                            class="alt-font text-large text-extra-dark-gray margin-40px-bottom d-inline-block font-weight-500">Questions</span>
                        <div class="row">
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Whether you are employed or doing any business? If yes,
                                    then details please? <span class="text-radical-red"> *</span></label>
                                <input class="small-input" type="text" name="question_1" placeholder="Your Answer"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom">Will you join this program as full time student or part
                                    time? <span class="text-radical-red"> *</span></label>
                                <input class="small-input" type="text" name="question_2" placeholder="Your Answer"
                                    required>
                            </div>

                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom" for="contry">Do you want to avail scholarship or not?
                                    <span class="text-radical-red">*</span></label>
                                <select name="question_3" id="board" class="small-input" required>
                                    <option value="">Select a Board</option>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom" for="contry">I want to avail scholarship with the
                                    following facilities? <span class="text-radical-red">*</span></label>
                                <select name="question_4" id="board" class="small-input" required>
                                    <option value="">Select a Board</option>
                            ...
                            <div class="col-md-6 margin-10px-bottom">
                                <label class="margin-15px-bottom" for="contry">I can afford, I want to pay monthly fee?
                                    <span class="text-radical-red">*</span></label>
                                <select name="question_5" id="board" class="small-input" required>
                                    <option value="">Select a Board</option>
                        ...
                        <button type="submit" style="width: 100px;" class="btn btn-primary">Apply</button>
                    </div>
